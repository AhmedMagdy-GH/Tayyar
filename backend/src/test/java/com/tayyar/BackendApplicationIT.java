...
@SpringBootTest
@EntityScan(basePackageClasses = {MigrationProbe.class, com.tayyar.user.User.class, com.tayyar.restaurant.Restaurant.class, com.tayyar.branch.Branch.class, com.tayyar.menu.Menu.class, com.tayyar.address.CustomerAddress.class})
